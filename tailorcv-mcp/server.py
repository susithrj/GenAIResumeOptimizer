...
def optimize_resume(resume_text: str, jd_text: str, target_role: str = "java_developer") -> dict:
    ...
    Returns:
      ...
      - rewritten_resume_text: Full resume text with surgical bullet/summary replacements.
    """
    canonical = normalize_newlines(resume_text)
    parsed_resume = parse_resume(canonical.strip())
    ...
    rewrite = rewrite_resume(
        ...
        raw_resume_text=canonical,
    )
    rewrite_dump = rewrite.model_dump()
    merged = build_merged_resume_text(
        canonical,
        rewrite_dump,
    ...
    return {
        ...
        "rewritten_bullets": rewrite_dump,
        "rewritten_resume_text": merged,
    }
...
def optimize_resume_to_docx(
    ...
    merged_plain = build_merged_resume_text(
        canonical,
        rewrite_dump,
        parsed_summary=parsed_resume.summary,
    )
    ...
    return {
        ...
        "weak_sections": gaps.weak_sections,
        "rewritten_bullets": rewrite_dump,
        "rewritten_resume_text": merged_plain,
    }
